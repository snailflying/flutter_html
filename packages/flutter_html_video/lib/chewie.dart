...
typedef ChewieRoutePageBuilder = Widget Function(
  ...
  CustomChewieControllerProvider controllerProvider,
);
...
class ChewieState extends State<CustomChewie> {
  ...
  Widget build(BuildContext context) {
    return CustomChewieControllerProvider(
      controller: widget.controller,
      child: ChangeNotifierProvider<PlayerNotifier>.value(
        value: notifier,
        builder: (context, w) => const CustomPlayerWithControls(),
      ),
    );
  }
  ...
  Widget _fullScreenRoutePageBuilder(
    ...
    final controllerProvider = CustomChewieControllerProvider(
      controller: widget.controller,
      child: ChangeNotifierProvider<PlayerNotifier>.value(
        value: notifier,
        builder: (context, w) => const CustomPlayerWithControls(),
...
/// The CustomChewieController is used to configure and drive the Chewie Player
...
///
/// In addition, you can listen to the CustomChewieController for presentational
...
class CustomChewieController extends ChangeNotifier {
  ...
  CustomChewieController copyWith({
    ...
    Widget Function(
      ...
      Animation<double>,
      Animation<double>,
      CustomChewieControllerProvider,
    )? routePageBuilder,
  }) {
    return CustomChewieController(
  ...
  static CustomChewieController of(BuildContext context) {
    final customChewieControllerProvider =
        context.dependOnInheritedWidgetOfExactType<CustomChewieControllerProvider>()!;

    return customChewieControllerProvider.controller;
  }
  ...
  //TODO: 解决无法退出全屏bug add by liuzhiqiang
...
class CustomChewieControllerProvider extends InheritedWidget {
  const CustomChewieControllerProvider({
    Key? key,
    required this.controller,
  ...
  @override
  bool updateShouldNotify(CustomChewieControllerProvider oldWidget) => controller != oldWidget.controller;
}
