...
class _CustomCupertinoControlsState extends State<CustomCupertinoControls> with SingleTickerProviderStateMixin {
  ...
  CustomChewieController get chewieController => _chewieController!;
  ...
  void didChangeDependencies() {
    ...
    _chewieController = CustomChewieController.of(context);
  ...
  //TODO: 解决因为dispose导致的点击失效bug add by liuzhiqiang[START]
  _hideStuff(bool isHide) {
    try {
      notifier.hideStuff = isHide;
    } catch (e) {
      print("e:$e");
    }
  }

  //TODO: 解决因为dispose导致的点击失效bug add by liuzhiqiang[END]
